...
class EditorViewOld @JvmOverloads constructor(
    ...
    private var editType: EditTypeOld? = null
            ...
            MotionEvent.ACTION_MOVE -> {
                if (editType != null) {
                    ...
                    when (editType) {
                        ...
                        EditTypeOld.LEFT_BOTTOM_CORNER_ -> {
                            if (startTopSizes!!.x - dx.toInt() > 200 && startTopSizes!!.y - dy.toInt() > 200) {
                                topView.translationX = startTopPoint!!.x + dx
                                topView.layoutParams = LayoutParams(
                                    startTopSizes!!.x - dx.toInt(),
                        ...
                        EditTypeOld.RIGHT_BOTTOM_CORNER_ -> {
                            if (startTopSizes!!.x - dx.toInt() > 200 && startTopSizes!!.y - dy.toInt() > 200) {
                                topView.layoutParams = LayoutParams(
                                    startTopSizes!!.x + dx.toInt(),
                                    startTopSizes!!.y + dy.toInt()
...
//                            topView.translationY = MathUtils.clamp(startTopPoint!!.y + dy, -vSpace, vSpace)
    ...
    fun getEditType(event: MotionEvent): EditTypeOld? {
        ...
        if (distSqr(
            ...
            return EditTypeOld.LEFT_TOP_CORNER_
            ...
            return EditTypeOld.RIGHT_TOP_CORNER_
            ...
            return EditTypeOld.LEFT_BOTTOM_CORNER_
            ...
            return EditTypeOld.RIGHT_BOTTOM_CORNER_
        }
        return null
    }
    ...
    enum class EditTypeOld {
        LEFT_TOP_CORNER_,
        RIGHT_TOP_CORNER_,
        LEFT_BOTTOM_CORNER_,
        RIGHT_BOTTOM_CORNER_,
        ROTATE_,
        ALL_
    }
}